...
class PoetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poet" do
    assert_difference('Poet.count') do
      post poets_url, params: { poet: { email: @poet.email, firstname: @poet.firstname, lastname: @poet.lastname, password: @poet.password, user_id: @poet.user_id, username: @poet.username } }
    end
  ...
  test "should update poet" do
    patch poet_url(@poet), params: { poet: { email: @poet.email, firstname: @poet.firstname, lastname: @poet.lastname, password: @poet.password, user_id: @poet.user_id, username: @poet.username } }
